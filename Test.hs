...
main = do
  ...
  putStrLn "FreeType.Raw.Core.Version"
  ...
  putStrLn "FreeType.Raw.Core.Base"
  ...
  putStrLn "FreeType.Raw.Core.Unicode"
  ...
  putStrLn "FreeType.Raw.Core.Color"
  ...
  putStrLn "FreeType.Raw.Core.Layer"
  report 'ft_Get_Color_Glyph_Layer ft_Get_Color_Glyph_Layer

  putStrLn "FreeType.Raw.Core.Glyph"
  ...
  putStrLn "FreeType.Raw.Core.Mac"
  ...
  putStrLn "FreeType.Raw.Format.TrueType"
  ...
  putStrLn "FreeType.Raw.Format.Type1"
  ...
  putStrLn "FreeType.Raw.Format.Sfnt"
  ...
  putStrLn "FreeType.Raw.Format.PFR" 
  ...
  putStrLn "FreeType.Raw.Format.WinFNT"
  report 'ft_Get_WinFNT_Header ft_Get_WinFNT_Header

  putStrLn "FreeType.Raw.Format.Font"
  report 'ft_Get_Font_Format ft_Get_Font_Format

  putStrLn "FreeType.Raw.Format.Gasp"
  report 'ft_Get_Gasp ft_Get_Gasp

  putStrLn "FreeType.Raw.Control.Subpixel"
  ...
  putStrLn "FreeType.Raw.Support.Computations"
  ...
  putStrLn "FreeType.Raw.Support.List"
  ...
  putStrLn "FreeType.Raw.Support.Outline"
  ...
  putStrLn "FreeType.Raw.Support.Glyph"
  ...
  putStrLn "FreeType.Raw.Support.Module"
