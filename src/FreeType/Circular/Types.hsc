...
data {-# CTYPE "freetype/internal/ftobjs.h" "FT_LibraryRec" #-} FT_LibraryRec



type FT_Face = Ptr FT_FaceRec

data {-# CTYPE "freetype/freetype.h" "FT_FaceRec" #-} FT_FaceRec =
       FT_FaceRec
         { num_faces           :: FT_Long
         , face_index          :: FT_Long
         , face_flags          :: FT_Long
...
data {-# CTYPE "freetype/freetype.h" "FT_Bitmap_Size" #-} FT_Bitmap_Size =
       FT_Bitmap_Size
         { height :: FT_Short
         , width  :: FT_Short
         , size   :: FT_Pos
...
data {-# CTYPE "freetype/freetype.h" "FT_CharMapRec" #-} FT_CharMapRec =
       FT_CharMapRec
         { face        :: FT_Face
...
data {-# CTYPE "freetype/freetype.h" "FT_GlyphSlotRec" #-} FT_GlyphSlotRec =
       FT_GlyphSlotRec
         { library           :: FT_Library
         , face              :: FT_Face
         , next              :: FT_GlyphSlot
...
data {-# CTYPE "freetype/freetype.h" "FT_SizeRec" #-} FT_SizeRec =
       FT_SizeRec
         { face     :: FT_Face
         , generic  :: FT_Generic
...
data {-# CTYPE "freetype/internal/ftobjs.h" "FT_Face_InternalRec" #-} FT_Face_InternalRec
type FT_Face_Internal = Ptr FT_Face_InternalRec



data {-# CTYPE "freetype/internal/ftobjs.h" "FT_Size_InternalRec" #-} FT_Size_InternalRec
type FT_Size_Internal = Ptr FT_Size_InternalRec



data {-# CTYPE "freetype/internal/ftobjs.h" "FT_Slot_InternalRec" #-} FT_Slot_InternalRec
type FT_Slot_Internal = Ptr FT_Slot_InternalRec



data {-# CTYPE "freetype/freetype.h" "FT_Glyph_Metrics" #-} FT_Glyph_Metrics =
       FT_Glyph_Metrics
         { width        :: FT_Pos
         , height       :: FT_Pos
         , horiBearingX :: FT_Pos
...
data {-# CTYPE "freetype/freetype.h" "FT_SubGlyphRec" #-} FT_SubGlyphRec
type FT_SubGlyph = Ptr FT_SubGlyphRec



data {-# CTYPE "freetype/freetype.h" "FT_Size_Metrics" #-} FT_Size_Metrics =
       FT_Size_Metrics
         { x_ppem      :: FT_UShort
         , y_ppem      :: FT_UShort
         , x_scale     :: FT_Fixed
...
data {-# CTYPE "freetype/internal/ftobjs.h" "FT_ModuleRec" #-} FT_ModuleRec
type FT_Module = Ptr FT_ModuleRec



data {-# CTYPE "freetype/internal/ftobjs.h" "FT_DriverRec" #-} FT_DriverRec
...
data {-# CTYPE "extra/ftinternal.h" "FT_MemoryRec" #-} FT_MemoryRec =
       FT_MemoryRec
         { user    :: Ptr ()
...
data {-# CTYPE "freetype/ftsystem.h" "FT_StreamRec" #-} FT_StreamRec =
       FT_StreamRec
...
data {-# CTYPE "freetype/ftsystem.h" "FT_StreamDesc" #-} FT_StreamDesc
...
data {-# CTYPE "freetype/ftimage.h" "FT_Outline" #-} FT_Outline =
       FT_Outline
...
data {-# CTYPE "freetype/fttypes.h" "FT_ListRec" #-} FT_ListRec =
       FT_ListRec
         { head :: FT_ListNode
         , tail :: FT_ListNode
         }
...
data {-# CTYPE "freetype/fttypes.h" "FT_ListNodeRec" #-} FT_ListNodeRec =
       FT_ListNodeRec
         { prev  :: FT_ListNode
         , next  :: FT_ListNode
         , data_ :: Ptr ()
