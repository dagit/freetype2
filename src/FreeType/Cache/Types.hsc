...
data {-# CTYPE "ftcmanag.h" "FTC_ManagerRec" #-} FTC_ManagerRec
...
data {-# CTYPE "ftccache.h" "FTC_NodeRec" #-} FTC_NodeRec
type FTC_Node = Ptr FTC_NodeRec



data {-# CTYPE "extra/ftinternal.h" "FTC_ImageCacheRec" #-} FTC_ImageCacheRec
...
data {-# CTYPE "extra/ftinternal.h" "FTC_SBitCacheRec" #-} FTC_SBitCacheRec
type FTC_SBitCache = Ptr FTC_SBitCacheRec



data {-# CTYPE "extra/ftinternal.h" "FTC_CMapCacheRec" #-} FTC_CMapCacheRec
type FTC_CMapCache = Ptr FTC_CMapCacheRec



data {-# CTYPE "freetype/ftcache.h" "FTC_ScalerRec" #-} FTC_ScalerRec =
       FTC_ScalerRec
         { face_id :: FTC_FaceID
         , width   :: FT_UInt
         , height  :: FT_UInt
...
data {-# CTYPE "freetype/ftcache.h" "FTC_ImageTypeRec" #-} FTC_ImageTypeRec =
       FTC_ImageTypeRec
         { face_id :: FTC_FaceID
         , width   :: FT_UInt
         , height  :: FT_UInt
...
data {-# CTYPE "freetype/ftcache.h" "FTC_SBitRec" #-} FTC_SBitRec =
       FTC_SBitRec
         { width     :: FT_Byte
         , height    :: FT_Byte
         , left      :: FT_Char
