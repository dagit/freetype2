...
foreign import capi unsafe "freetype/freetype.h FT_HAS_HORIZONTAL"
  ft_has_horizontal :: FT_Face -> IO FT_Bool

pattern FT_HAS_HORIZONTAL :: FT_Face -> IO FT_Bool
...
foreign import capi unsafe "freetype/freetype.h FT_HAS_VERTICAL"
  ft_has_vertical :: FT_Face -> IO FT_Bool

pattern FT_HAS_VERTICAL :: FT_Face -> IO FT_Bool
...
foreign import capi unsafe "freetype/freetype.h FT_HAS_KERNING"
  ft_has_kerning :: FT_Face -> IO FT_Bool

pattern FT_HAS_KERNING :: FT_Face -> IO FT_Bool
...
foreign import capi unsafe "freetype/freetype.h FT_HAS_FIXED_SIZES"
  ft_has_has_sizes :: FT_Face -> IO FT_Bool

pattern FT_HAS_FIXED_SIZES :: FT_Face -> IO FT_Bool
pattern FT_HAS_FIXED_SIZES <- _
  where
    FT_HAS_FIXED_SIZES = ft_has_has_sizes



foreign import capi unsafe "freetype/freetype.h FT_HAS_GLYPH_NAMES"
  ft_has_glyph_names :: FT_Face -> IO FT_Bool

pattern FT_HAS_GLYPH_NAMES :: FT_Face -> IO FT_Bool
...
foreign import capi unsafe "freetype/freetype.h FT_HAS_COLOR"
  ft_has_color :: FT_Face -> IO FT_Bool

pattern FT_HAS_COLOR :: FT_Face -> IO FT_Bool
...
foreign import capi unsafe "freetype/freetype.h FT_HAS_MULTIPLE_MASTERS"
  ft_has_multiple_masters :: FT_Face -> IO FT_Bool

pattern FT_HAS_MULTIPLE_MASTERS :: FT_Face -> IO FT_Bool
...
foreign import capi unsafe "freetype/freetype.h FT_HAS_SVG"
  ft_has_svg :: FT_Face -> IO FT_Bool

pattern FT_HAS_SVG :: FT_Face -> IO FT_Bool
...
foreign import capi unsafe "freetype/freetype.h FT_HAS_SBIX"
  ft_has_sbix :: FT_Face -> IO FT_Bool

pattern FT_HAS_SBIX :: FT_Face -> IO FT_Bool
pattern FT_HAS_SBIX <- _
  where
    FT_HAS_SBIX = ft_has_sbix



foreign import capi unsafe "freetype/freetype.h FT_HAS_SBIX_OVERLAY"
  ft_has_sbix_overlay :: FT_Face -> IO FT_Bool

pattern FT_HAS_SBIX_OVERLAY :: FT_Face -> IO FT_Bool
pattern FT_HAS_SBIX_OVERLAY <- _
  where
    FT_HAS_SBIX_OVERLAY = ft_has_sbix_overlay



foreign import capi unsafe "freetype/freetype.h FT_IS_SFNT"
  ft_is_sfnt :: FT_Face -> IO FT_Bool

pattern FT_IS_SFNT :: FT_Face -> IO FT_Bool
...
foreign import capi unsafe "freetype/freetype.h FT_IS_SCALABLE"
  ft_is_scalable :: FT_Face -> IO FT_Bool

pattern FT_IS_SCALABLE :: FT_Face -> IO FT_Bool
...
foreign import capi unsafe "freetype/freetype.h FT_IS_FIXED_WIDTH"
  ft_is_fixed_width :: FT_Face -> IO FT_Bool

pattern FT_IS_FIXED_WIDTH :: FT_Face -> IO FT_Bool
pattern FT_IS_FIXED_WIDTH <- _
  where
    FT_IS_FIXED_WIDTH = ft_is_fixed_width



foreign import capi unsafe "freetype/freetype.h FT_IS_CID_KEYED"
  ft_is_cid_keyed :: FT_Face -> IO FT_Bool

pattern FT_IS_CID_KEYED :: FT_Face -> IO FT_Bool
pattern FT_IS_CID_KEYED <- _
  where
    FT_IS_CID_KEYED = ft_is_cid_keyed



foreign import capi unsafe "freetype/freetype.h FT_IS_TRICKY"
  ft_is_tricky :: FT_Face -> IO FT_Bool

pattern FT_IS_TRICKY :: FT_Face -> IO FT_Bool
pattern FT_IS_TRICKY <- _
  where
    FT_IS_TRICKY = ft_is_tricky



foreign import capi unsafe "freetype/freetype.h FT_IS_NAMED_INSTANCE"
  ft_is_named_instance :: FT_Face -> IO FT_Bool

pattern FT_IS_NAMED_INSTANCE :: FT_Face -> IO FT_Bool
...
foreign import capi unsafe "freetype/freetype.h FT_IS_VARIATION"
  ft_is_variation :: FT_Face -> IO FT_Bool

pattern FT_IS_VARIATION :: FT_Face -> IO FT_Bool
...
foreign import CALLCV "freetype/freetype.h FT_Init_FreeType"
  ft_Init_FreeType
...
foreign import CALLCV "freetype/freetype.h FT_Done_FreeType"
  ft_Done_FreeType
    :: FT_Library  -- ^ library
    -> IO FT_Error
...
foreign import CALLCV "freetype/freetype.h FT_New_Face"
  ft_New_Face
    :: FT_Library       -- ^ library
...
foreign import CALLCV "freetype/freetype.h FT_Done_Face"
  ft_Done_Face
    :: FT_Face     -- ^ face
    -> IO FT_Error
...
foreign import CALLCV "freetype/freetype.h FT_Reference_Face"
  ft_Reference_Face
    :: FT_Face     -- ^ face
    -> IO FT_Error
...
foreign import CALLCV "freetype/freetype.h FT_New_Memory_Face"
  ft_New_Memory_Face
    :: FT_Library  -- ^ library
...
foreign import CALLCV "freetype/freetype.h FT_Face_Properties"
  ft_Face_Properties
    :: FT_Face          -- ^ face
...
foreign import CALLCV "freetype/freetype.h FT_Open_Face"
  ft_Open_Face
    :: FT_Library       -- ^ library
...
foreign import CALLCV "freetype/freetype.h FT_Attach_File"
  ft_Attach_File
    :: FT_Face
    -> Ptr #{type char} -- ^ face
...
foreign import CALLCV "freetype/freetype.h FT_Attach_Stream"
  ft_Attach_Stream
    :: FT_Face          -- ^ face
...
foreign import CALLCV "freetype/freetype.h FT_Set_Char_Size"
  ft_Set_Char_Size
    :: FT_Face    -- ^ face
...
foreign import CALLCV "freetype/freetype.h FT_Set_Pixel_Sizes"
  ft_Set_Pixel_Sizes
    :: FT_Face     -- ^ face
    -> FT_UInt     -- ^ pixel_width
...
foreign import CALLCV "freetype/freetype.h FT_Request_Size"
  ft_Request_Size
    :: FT_Face         -- ^ face
    -> FT_Size_Request -- ^ req
    -> IO FT_Error
...
foreign import CALLCV "freetype/freetype.h FT_Select_Size"
  ft_Select_Size
    :: FT_Face     -- ^ face
    -> FT_Int      -- ^ strike_index
    -> IO FT_Error
...
foreign import CALLCV "freetype/freetype.h FT_Set_Transform"
  ft_Set_Transform
    :: FT_Face       -- ^ face
...
foreign import CALLCV "freetype/freetype.h FT_Get_Transform"
  ft_Get_Transform
    :: FT_Face       -- ^ face
    -> Ptr FT_Matrix -- ^ matrix
    -> Ptr FT_Vector -- ^ delta
...
foreign import CALLCV "freetype/freetype.h FT_Load_Glyph"
  ft_Load_Glyph
    :: FT_Face     -- ^ face
    -> FT_UInt     -- ^ glyph_index
    -> FT_Int32    -- ^ load_flags
...
foreign import CALLCV "freetype/freetype.h FT_Get_Char_Index"
  ft_Get_Char_Index
    :: FT_Face    -- ^ face
    -> FT_ULong   -- ^ charcode
    -> IO FT_UInt
...
foreign import CALLCV "freetype/freetype.h FT_Get_First_Char"
  ft_Get_First_Char
    :: FT_Face     -- ^ face
    -> Ptr FT_UInt -- ^ agindex
    -> IO FT_ULong
...
foreign import CALLCV "freetype/freetype.h FT_Get_Next_Char"
  ft_Get_Next_Char
    :: FT_Face     -- ^ face
    -> FT_ULong    -- ^ char_code
    -> Ptr FT_UInt -- ^ agindex
...
foreign import CALLCV "freetype/freetype.h FT_Get_Name_Index"
  ft_Get_Name_Index
    :: FT_Face       -- ^ face
...
foreign import CALLCV "freetype/freetype.h FT_Load_Char"
  ft_Load_Char
    :: FT_Face     -- ^ face
    -> FT_ULong    -- ^ char_code
    -> FT_Int32    -- ^ load_flags
...
foreign import CALLCV "freetype/freetype.h FT_Render_Glyph"
  ft_Render_Glyph
    :: FT_GlyphSlot   -- ^ slot
...
foreign import CALLCV unsafe "freetype/freetype.h FT_Get_Kerning"
  ft_Get_Kerning
    :: FT_Face       -- ^ face
    -> FT_UInt       -- ^ left_glyph
    -> FT_UInt       -- ^ right_glyph
...
foreign import CALLCV "freetype/freetype.h FT_Get_Track_Kerning"
  ft_Get_Track_Kerning
    :: FT_Face      -- ^ face
    -> FT_Fixed     -- ^ point_size
    -> FT_Int       -- ^ degree
...
foreign import CALLCV "freetype/freetype.h FT_Get_Glyph_Name"
  ft_Get_Glyph_Name
    :: FT_Face     -- ^ face
    -> FT_UInt     -- ^ glyph_index
    -> FT_Pointer  -- ^ buffer
...
foreign import CALLCV "freetype/freetype.h FT_Get_Postscript_Name"
  ft_Get_Postscript_Name
    :: FT_Face               -- ^ face
    -> IO (Ptr #{type char})
...
foreign import CALLCV "freetype/freetype.h FT_Select_Charmap"
  ft_Select_Charmap
    :: FT_Face     -- ^ face
...
foreign import CALLCV "freetype/freetype.h FT_Set_Charmap"
  ft_Set_Charmap
    :: FT_Face     -- ^ face
    -> FT_CharMap  -- ^ charmap
    -> IO FT_Error
...
foreign import CALLCV "freetype/freetype.h FT_Get_Charmap_Index"
  ft_Get_Charmap_Index
    :: FT_CharMap -- ^ charmap
    -> IO FT_Int
...
foreign import CALLCV "freetype/freetype.h FT_Get_FSType_Flags"
  ft_Get_FSType_Flags
    :: FT_Face      -- ^ face
    -> IO FT_UShort
...
foreign import CALLCV "freetype/freetype.h FT_Get_SubGlyph_Info"
  ft_Get_SubGlyph_Info
    :: FT_GlyphSlot  -- ^ glyph
    -> FT_UInt       -- ^ sub_index
    -> Ptr FT_Int    -- ^ p_index
