...
data {-# CTYPE "freetype/ftglyph.h" "FT_Glyph_Class" #-} FT_Glyph_Class

data {-# CTYPE "freetype/ftglyph.h" "FT_GlyphRec" #-} FT_GlyphRec =
       FT_GlyphRec
         { library :: FT_Library
...
data {-# CTYPE "freetype/ftglyph.h" "FT_BitmapGlyphRec" #-} FT_BitmapGlyphRec =
       FT_BitmapGlyphRec
         { root   :: FT_GlyphRec
         , left   :: FT_Int
         , top    :: FT_Int
...
data {-# CTYPE "freetype/ftglyph.h" "FT_OutlineGlyphRec" #-} FT_OutlineGlyphRec =
       FT_OutlineGlyphRec
         { root    :: FT_GlyphRec
         , outline :: FT_Outline
         }
...
data {-# CTYPE "freetype/ftglyph.h" "FT_SvgGlyphRec" #-} FT_SvgGlyphRec =
       FT_SvgGlyphRec
         { root                :: FT_GlyphRec
