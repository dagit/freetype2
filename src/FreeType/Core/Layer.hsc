...
#include "ft2build.h"
#include FT_COLOR_H
#include "extra/ftlayer.h"

foreign import CALLCV "freetype/ftcolor.h FT_Get_Color_Glyph_Layer"
  ft_Get_Color_Glyph_Layer
    :: FT_Face              -- ^ face
    -> FT_UInt              -- ^ base_glyph
...
foreign import CALLCV "freetype/ftcolor.h FT_Get_Color_Glyph_Paint"
  ft_Get_Color_Glyph_Paint
    :: FT_Face                 -- ^ face
    -> FT_UInt                 -- ^ base_glyph
...
foreign import CALLCV "freetype/ftcolor.h FT_Get_Color_Glyph_ClipBox"
  ft_Get_Color_Glyph_ClipBox
    :: FT_Face        -- ^ face
    -> FT_UInt        -- ^ base_glyph
...
foreign import CALLCV "freetype/ftcolor.h FT_Get_Paint_Layers"
  ft_Get_Paint_Layers
    :: FT_Face              -- ^ face
    -> Ptr FT_LayerIterator -- ^ iterator
    -> Ptr FT_OpaquePaint   -- ^ paint
...
foreign import CALLCV "freetype/ftcolor.h FT_Get_Colorline_Stops"
  ft_Get_Colorline_Stops
    :: FT_Face                  -- ^ face
...
foreign import CALLCV "extra/ftlayer.h FT_Get_Paint_ptr"
  ft_Get_Paint
    :: FT_Face           -- ^ face
