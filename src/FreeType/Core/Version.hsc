...
foreign import CALLCV "freetype/freetype.h FT_Library_Version"
  ft_Library_Version
    :: FT_Library -- ^ library
    -> Ptr FT_Int -- ^ amajor
    -> Ptr FT_Int -- ^ aminor
...
foreign import CALLCV "freetype/freetype.h FT_Face_CheckTrueTypePatents"
  ft_Face_CheckTrueTypePatents
    :: FT_Face    -- ^ face
    -> IO FT_Bool
...
foreign import CALLCV "freetype/freetype.h FT_Face_SetUnpatentedHinting"
  ft_Face_SetUnpatentedHinting
    :: FT_Face    -- ^ face
    -> FT_Bool    -- ^ value
    -> IO FT_Bool
