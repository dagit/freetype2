...
data {-# CTYPE "freetype/freetype.h" "FT_Open_Args" #-} FT_Open_Args =
       FT_Open_Args
         { flags       :: FT_UInt
...
data {-# CTYPE "freetype/freetype.h" "FT_Parameter" #-} FT_Parameter =
       FT_Parameter
         { tag   :: FT_ULong
         , data_ :: FT_Pointer
         }
...
data {-# CTYPE "freetype/freetype.h" "FT_Size_RequestRec" #-} FT_Size_RequestRec =
       FT_Size_RequestRec
