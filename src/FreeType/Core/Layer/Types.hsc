...
data {-# CTYPE "freetype/ftcolor.h" "FT_LayerIterator" #-} FT_LayerIterator =
       FT_LayerIterator
         { num_layers :: FT_UInt
         , layer      :: FT_UInt
         , p          :: Ptr FT_Byte
...
data {-# CTYPE "freetype/ftcolor.h" "FT_ColorStopIterator" #-} FT_ColorStopIterator =
...
data {-# CTYPE "freetype/ftcolor.h" "FT_ColorIndex" #-} FT_ColorIndex =
       FT_ColorIndex
...
data {-# CTYPE "freetype/ftcolor.h" "FT_ColorStop" #-} FT_ColorStop =
       FT_ColorStop
...
data {-# CTYPE "freetype/ftcolor.h" "FT_ColorLine" #-} FT_ColorLine =
       FT_ColorLine
...
data {-# CTYPE "freetype/ftcolor.h" "FT_Affine23" #-} FT_Affine23 =
       FT_Affine23
         { xx :: FT_Fixed
         , xy :: FT_Fixed
         , dx :: FT_Fixed
...
data {-# CTYPE "freetype/ftcolor.h" "FT_OpaquePaint" #-} FT_OpaquePaint =
       FT_OpaquePaint
         { p                     :: Ptr FT_Byte
...
data {-# CTYPE "freetype/ftcolor.h" "FT_PaintColrLayers" #-} FT_PaintColrLayers =
       FT_PaintColrLayers
...
newtype {-# CTYPE "freetype/ftcolor.h" "FT_PaintSolid" #-} FT_PaintSolid =
       FT_PaintSolid
         { color :: FT_ColorIndex
         }
...
data {-# CTYPE "freetype/ftcolor.h" "FT_PaintLinearGradient" #-} FT_PaintLinearGradient =
...
data {-# CTYPE "freetype/ftcolor.h" "FT_PaintRadialGradient" #-} FT_PaintRadialGradient =
...
data {-# CTYPE "freetype/ftcolor.h" "FT_PaintSweepGradient" #-} FT_PaintSweepGradient =
...
data {-# CTYPE "freetype/ftcolor.h" "FT_PaintGlyph" #-} FT_PaintGlyph =
       FT_PaintGlyph
...
newtype {-# CTYPE "freetype/ftcolor.h" "FT_PaintColrGlyph" #-} FT_PaintColrGlyph =
       FT_PaintColrGlyph
         { glyphID :: FT_UInt
         }
...
data {-# CTYPE "freetype/ftcolor.h" "FT_PaintTransform" #-} FT_PaintTransform =
       FT_PaintTransform
         { paint  :: FT_OpaquePaint
         , affine :: FT_Affine23
         }
...
data {-# CTYPE "freetype/ftcolor.h" "FT_PaintTransform" #-} FT_PaintTranslate =
       FT_PaintTranslate
         { paint  :: FT_OpaquePaint
         , dx     :: FT_Fixed
         , dy     :: FT_Fixed
...
data {-# CTYPE "freetype/ftcolor.h" "FT_PaintScale" #-} FT_PaintScale =
       FT_PaintScale
         { paint    :: FT_OpaquePaint
         , scale_x  :: FT_Fixed
         , scale_y  :: FT_Fixed
...
data {-# CTYPE "freetype/ftcolor.h" "FT_PaintRotate" #-} FT_PaintRotate =
       FT_PaintRotate
         { paint    :: FT_OpaquePaint
         , angle    :: FT_Fixed
         , center_x :: FT_Fixed
...
data {-# CTYPE "freetype/ftcolor.h" "FT_PaintSkew" #-} FT_PaintSkew =
       FT_PaintSkew
         { paint        :: FT_OpaquePaint
...
data {-# CTYPE "freetype/ftcolor.h" "FT_PaintComposite" #-} FT_PaintComposite =
       FT_PaintComposite
...
newtype {-# CTYPE "freetype/ftcolor.h" "FT_COLR_Paint" #-} FT_COLR_Paint =
       FT_COLR_Paint
...
data {-# CTYPE "freetype/ftcolor.h" "FT_ClipBox" #-} FT_ClipBox =
       FT_ClipBox
