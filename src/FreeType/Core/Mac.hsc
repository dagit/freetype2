...
foreign import CALLCV "freetype/ftmac.h FT_New_Face_From_FOND"
  ft_New_Face_From_FOND
    :: FT_Library  -- ^ library
    -> Handle      -- ^ fond
    -> FT_Long     -- ^ face_index
...
foreign import CALLCV "freetype/ftmac.h FT_GetFile_From_Mac_Name"
  ft_GetFile_From_Mac_Name
    :: Ptr CChar   -- ^ fontName
    -> Ptr FSSpec  -- ^ pathSpec
...
foreign import CALLCV "freetype/ftmac.h FT_GetFile_From_Mac_ATS_Name"
  ft_GetFile_From_Mac_ATS_Name
    :: Ptr CChar   -- ^ fontName
    -> Ptr FSSpec  -- ^ pathSpec
    -> Ptr FT_Long -- ^ face_index
...
foreign import CALLCV "freetype/ftmac.h FT_GetFilePath_From_Mac_ATS_Name"
  ft_GetFilePath_From_Mac_ATS_Name
    :: Ptr CChar   -- ^ fontName
    -> Ptr Word8   -- ^ path
    -> Word32      -- ^ maxPathSize
...
foreign import CALLCV "freetype/ftmac.h FT_New_Face_From_FSSpec"
  ft_New_Face_From_FSSpec
    :: FT_Library  -- ^ library
    -> Ptr FSSpec  -- ^ spec
    -> FT_Long     -- ^ face_index
...
foreign import CALLCV "freetype/ftmac.h FT_New_Face_From_FSRef"
  ft_New_Face_From_FSRef
    :: FT_Library  -- ^ library
    -> Ptr FSRef   -- ^ ref
    -> FT_Long     -- ^ face_index
