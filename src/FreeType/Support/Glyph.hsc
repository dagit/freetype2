...
foreign import CALLCV "freetype/ftstroke.h FT_Outline_GetInsideBorder"
  ft_Outline_GetInsideBorder
...
foreign import CALLCV "freetype/ftstroke.h FT_Outline_GetOutsideBorder"
  ft_Outline_GetOutsideBorder
    :: Ptr FT_Outline      -- ^ outline
    -> IO FT_StrokerBorder
...
foreign import CALLCV "freetype/ftstroke.h FT_Glyph_Stroke"
  ft_Glyph_Stroke
    :: Ptr FT_Glyph -- ^ pglyph
    -> FT_Stroker   -- ^ stroker
    -> FT_Bool      -- ^ destroy
...
foreign import CALLCV "freetype/ftstroke.h FT_Glyph_StrokeBorder"
  ft_Glyph_StrokeBorder
    :: Ptr FT_Glyph -- ^ pglyph
    -> FT_Stroker   -- ^ stroker
    -> FT_Bool      -- ^ inside
...
foreign import CALLCV "freetype/ftstroke.h FT_Stroker_New"
  ft_Stroker_New
    :: FT_Library     -- ^ library
...
foreign import CALLCV "freetype/ftstroke.h FT_Stroker_Set"
  ft_Stroker_Set
    :: FT_Stroker          -- ^ stroker
    -> FT_Fixed            -- ^ radius
...
foreign import CALLCV "freetype/ftstroke.h FT_Stroker_Rewind"
  ft_Stroker_Rewind
    :: FT_Stroker -- ^ stroker
    -> IO ()
...
foreign import CALLCV "freetype/ftstroke.h FT_Stroker_ParseOutline"
  ft_Stroker_ParseOutline
    :: FT_Stroker     -- ^ stroker
    -> Ptr FT_Outline -- ^ outline
    -> FT_Bool        -- ^ opened
...
foreign import CALLCV "freetype/ftstroke.h FT_Stroker_Done"
  ft_Stroker_Done :: FT_Stroker -> IO ()



foreign import CALLCV "freetype/ftstroke.h FT_Stroker_BeginSubPath"
  ft_Stroker_BeginSubPath
    :: FT_Stroker    -- ^ stroker
    -> Ptr FT_Vector -- ^ to
    -> FT_Bool       -- ^ open
...
foreign import CALLCV "freetype/ftstroke.h FT_Stroker_EndSubPath"
  ft_Stroker_EndSubPath
    :: FT_Stroker -- ^ stroker
    -> IO FT_Error
...
foreign import CALLCV "freetype/ftstroke.h FT_Stroker_LineTo"
  ft_Stroker_LineTo
    :: FT_Stroker    -- ^ stroker
    -> Ptr FT_Vector -- ^ to
    -> IO FT_Error
...
foreign import CALLCV "freetype/ftstroke.h FT_Stroker_ConicTo"
  ft_Stroker_ConicTo
    :: FT_Stroker    -- ^ stroker
...
foreign import CALLCV "freetype/ftstroke.h FT_Stroker_CubicTo"
  ft_Stroker_CubicTo
    :: FT_Stroker    -- ^ stroker
...
foreign import CALLCV "freetype/ftstroke.h FT_Stroker_GetBorderCounts"
  ft_Stroker_GetBorderCounts
    :: FT_Stroker       -- ^ stroker
...
foreign import CALLCV "freetype/ftstroke.h FT_Stroker_ExportBorder"
  ft_Stroker_ExportBorder :: FT_Stroker -> FT_StrokerBorder -> Ptr FT_Outline -> IO ()



foreign import CALLCV "freetype/ftstroke.h FT_Stroker_GetCounts"
  ft_Stroker_GetCounts
    :: FT_Stroker  -- ^ stroker
    -> Ptr FT_UInt -- ^ anum_points
    -> Ptr FT_UInt -- ^ anum_contours
...
foreign import CALLCV "freetype/ftstroke.h FT_Stroker_Export"
  ft_Stroker_Export
    :: FT_Stroker     -- ^ stroker
    -> Ptr FT_Outline -- ^ outline
    -> IO ()
