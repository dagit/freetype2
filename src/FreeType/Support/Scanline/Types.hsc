...
data {-# CTYPE "extra/ftinternal.h" "FT_RasterRec" #-} FT_RasterRec
type FT_Raster = Ptr FT_RasterRec



data {-# CTYPE "freetype/ftimage.h" "FT_Span" #-} FT_Span =
       FT_Span
         { x        :: CShort
         , len      :: CUShort
         , coverage :: CUChar
...
data {-# CTYPE "freetype/ftimage.h" "FT_Raster_Params" #-} FT_Raster_Params =
       FT_Raster_Params
...
data {-# CTYPE "freetype/ftimage.h" "FT_Raster_Funcs" #-} FT_Raster_Funcs =
       FT_Raster_Funcs
