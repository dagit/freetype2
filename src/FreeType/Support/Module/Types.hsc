...
data {-# CTYPE "freetype/ftmodapi.h" "FT_Module_Class" #-} FT_Module_Class =
       FT_Module_Class
...
data {-# CTYPE "freetype/internal/ftobjs.h" "FT_RendererRec" #-} FT_RendererRec
...
data {-# CTYPE "freetype/ftrender.h" "FT_Renderer_Class" #-} FT_Renderer_Class =
       FT_Renderer_Class
