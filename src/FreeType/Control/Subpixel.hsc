...
foreign import CALLCV "freetype/ftlcdfil.h FT_Library_SetLcdFilter"
  ft_Library_SetLcdFilter
    :: FT_Library   -- ^ library
    -> FT_LcdFilter -- ^ filter
    -> IO FT_Error
...
foreign import CALLCV "freetype/ftlcdfil.h FT_Library_SetLcdFilterWeights"
  ft_Library_SetLcdFilterWeights
    :: FT_Library                -- ^ library
...
foreign import CALLCV "freetype/ftlcdfil.h FT_Library_SetLcdGeometry"
  ft_Library_SetLcdGeometry
    :: FT_Library    -- ^ library
    -> Ptr FT_Vector -- ^ sub
    -> IO FT_Error
