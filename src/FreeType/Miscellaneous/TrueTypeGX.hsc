...
foreign import CALLCV "freetype/ftgxval.h FT_TrueTypeGX_Validate"
  ft_TrueTypeGX_Validate
    :: FT_Face      -- ^ face
...
foreign import CALLCV "freetype/ftgxval.h FT_TrueTypeGX_Free"
  ft_TrueTypeGX_Free
    :: FT_Face  -- ^ face
    -> FT_Bytes -- ^ table
    -> IO ()
...
foreign import CALLCV "freetype/ftgxval.h FT_ClassicKern_Validate"
  ft_ClassicKern_Validate
    :: FT_Face      -- ^ face
    -> FT_UInt      -- ^ validation_flags
...
foreign import CALLCV "freetype/ftgxval.h FT_ClassicKern_Free"
  ft_ClassicKern_Free
    :: FT_Face  -- ^ face
    -> FT_Bytes -- ^ table
    -> IO ()
