...
data {-# CTYPE "freetype/ftincrem.h" "FT_Incremental_MetricsRec" #-} FT_Incremental_MetricsRec =
...
data {-# CTYPE "freetype/ftincrem.h" "FT_Incremental_FuncsRec" #-} FT_Incremental_FuncsRec =
...
data {-# CTYPE "freetype/ftincrem.h" "FT_Incremental_InterfaceRec" #-} FT_Incremental_InterfaceRec =
