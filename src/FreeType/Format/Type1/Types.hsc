...
data {-# CTYPE "freetype/t1tables.h" "PS_FontInfoRec" #-} PS_FontInfoRec =
       PS_FontInfoRec
...
data {-# CTYPE "freetype/t1tables.h" "PS_PrivateRec" #-} PS_PrivateRec =
       PS_PrivateRec
         { unique_id              :: FT_Int
         , lenIV                  :: FT_Int
...
data {-# CTYPE "freetype/t1tables.h" "CID_FaceDictRec" #-} CID_FaceDictRec =
       CID_FaceDictRec
...
data {-# CTYPE "freetype/t1tables.h" "CID_FaceInfoRec" #-} CID_FaceInfoRec =
       CID_FaceInfoRec
