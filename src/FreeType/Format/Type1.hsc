...
foreign import CALLCV "freetype/t1tables.h FT_Has_PS_Glyph_Names"
  ft_Has_PS_Glyph_Names
    :: FT_Face   -- ^ face
    -> IO FT_Int
...
foreign import CALLCV "freetype/t1tables.h FT_Get_PS_Font_Info"
  ft_Get_PS_Font_Info
    :: FT_Face     -- ^ face
...
foreign import CALLCV "freetype/t1tables.h FT_Get_PS_Font_Private"
  ft_Get_PS_Font_Private
    :: FT_Face     -- ^ face
...
foreign import CALLCV "freetype/t1tables.h FT_Get_PS_Font_Value"
  ft_Get_PS_Font_Value
    :: FT_Face      -- ^ face
    -> PS_Dict_Keys -- ^ key
    -> FT_UInt      -- ^ idx
