...
foreign import CALLCV "freetype/ftsnames.h FT_Get_Sfnt_Name_Count"
  ft_Get_Sfnt_Name_Count :: FT_Face -> IO FT_UInt



foreign import CALLCV "freetype/ftsnames.h FT_Get_Sfnt_Name"
  ft_Get_Sfnt_Name
    :: FT_Face         -- ^ face
    -> FT_UInt         -- ^ idx
...
foreign import CALLCV "freetype/ftsnames.h FT_Get_Sfnt_LangTag"
  ft_Get_Sfnt_LangTag
    :: FT_Face            -- ^ face
    -> FT_UInt            -- ^ langID
