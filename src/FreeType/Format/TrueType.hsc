...
foreign import CALLCV "freetype/tttables.h FT_Get_Sfnt_Table"
  ft_Get_Sfnt_Table
    :: FT_Face     -- ^ face
    -> FT_Sfnt_Tag -- ^ tag
    -> IO (Ptr ())
...
foreign import CALLCV "freetype/tttables.h FT_Load_Sfnt_Table"
  ft_Load_Sfnt_Table
    :: FT_Face      -- ^ face
    -> FT_ULong     -- ^ tag
    -> FT_Long      -- ^ offset
...
foreign import CALLCV "freetype/tttables.h FT_Sfnt_Table_Info"
  ft_Sfnt_Table_Info
    :: FT_Face      -- ^ face
    -> FT_UInt      -- ^ table_index
    -> Ptr FT_ULong -- ^ tag
...
foreign import CALLCV "freetype/tttables.h FT_Get_CMap_Language_ID"
  ft_Get_CMap_Language_ID :: FT_CharMap -> IO FT_ULong



foreign import CALLCV "freetype/tttables.h FT_Get_CMap_Format"
