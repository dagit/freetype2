...
data {-# CTYPE "freetype/tttables.h" "TT_Header" #-} TT_Header =
       TT_Header
...
data {-# CTYPE "freetype/tttables.h" "TT_HoriHeader" #-} TT_HoriHeader =
       TT_HoriHeader
         { version                :: FT_Fixed
         , ascender               :: FT_Short
         , descender              :: FT_Short
...
data {-# CTYPE "freetype/tttables.h" "TT_VertHeader" #-} TT_VertHeader =
       TT_VertHeader
         { version                 :: FT_Fixed
         , ascender                :: FT_Short
         , descender               :: FT_Short
...
data {-# CTYPE "freetype/tttables.h" "TT_OS2" #-} TT_OS2 =
       TT_OS2
         { version                 :: FT_UShort
...
data {-# CTYPE "freetype/tttables.h" "TT_Postscript" #-} TT_Postscript =
       TT_Postscript
         { formatType         :: FT_Fixed
...
data {-# CTYPE "freetype/tttables.h" "TT_PCLT" #-} TT_PCLT =
       TT_PCLT
         { version             :: FT_Fixed
         , fontNumber          :: FT_ULong
         , pitch               :: FT_UShort
...
data {-# CTYPE "freetype/tttables.h" "TT_MaxProfile" #-} TT_MaxProfile =
       TT_MaxProfile
         { version               :: FT_Fixed
         , numGlyphs             :: FT_UShort
         , maxPoints             :: FT_UShort
