...
--   However it completing proves that all functions are bound, as pretty
...
main = do
  ...
  report "ft_Get_Color_Glyph_Paint"   ft_Get_Color_Glyph_Paint
  report "ft_Get_Color_Glyph_ClipBox" ft_Get_Color_Glyph_ClipBox
  report "ft_Get_Paint_Layers"        ft_Get_Paint_Layers
  report "ft_Get_Colorline_Stops"     ft_Get_Colorline_Stops
  report "ft_Get_Paint"               ft_Get_Paint
